...
function getOptions() {
    ...
    return arguments.length > 0 && isObject(arguments[0]) ? {
        bitSize: arguments[0].bitSize,
        clientFileName: arguments[0].clientFileName,
        C: arguments[0].country || arguments[0].C || defaultOptions.C,
        ST: arguments[0].state || arguments[0].ST || defaultOptions.ST,
        L: arguments[0].locality || arguments[0].L || defaultOptions.L,
        O: arguments[0].organization || arguments[0].O || defaultOptions.O,
        OU: arguments[0].organizationUnit || arguments[0].OU || defaultOptions.OU,
        CN: arguments[0].commonName || arguments[0].CN || defaultOptions.CN,
        emailAddress: arguments[0].emailAddress || defaultOptions.emailAddress,
        clientPass: arguments[0].clientPass || defaultOptions.clientPass,
        caFileName: arguments[0].caFileName || defaultOptions.caFileName,
        serial: arguments[0].serial|| defaultOptions.serial,
        days: arguments[0].days || defaultOptions.days,
        isEncryptionRequired : arguments[0].isEncryptionRequired || defaultOptions.isEncryptionRequired
    } : defaultOptions;
}
