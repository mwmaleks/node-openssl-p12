...
var generateCSRSubject = function() {
    ...
    var   options = !_.isEmpty( arguments ) ? arguments[0] : {}
        , csrData = {
...
var  createClientKey  = function() {
    ...
    opt.encryptionRequired  = opt.encryptionRequired ? opt.encryptionRequired : options.encryptionRequired;
...
//      create key
        var params = [ 'genrsa'];
        opt.encryptionRequired && params.push('-des3');
